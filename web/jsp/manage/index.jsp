...
<frameset rows="100px,*,19px" framespacing="0" border="0" frameborder="0">
    <frame src="details/top.jsp" scrolling="no" noresize />
    <frameset cols="178px,*">
        <frame noresize src="details/left.jsp" scrolling="yes" />
        <frame noresize name="right" src="details/right.jsp" scrolling="yes" />
    </frameset>
    <frame noresize name="status_bar" scrolling="no" src="details/bottom.jsp" />
</frameset>
<noframes>
    <body>
